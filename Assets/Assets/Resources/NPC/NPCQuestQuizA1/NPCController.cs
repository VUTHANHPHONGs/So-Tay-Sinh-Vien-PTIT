...
public class NPCController : TalkInteraction
{
    ...
    QuestManager_1 questManager;
    [Header("Quest Mission")]
    string questId;
    QuestStep_1 questStep;
    ...
    public override void Awake()
    {
        ...
        questManager = FindAnyObjectByType<QuestManager_1>();
        //create data map
    ...
    public void UpdateQuestStep(QuestStep_1 step, string questId)
    {
